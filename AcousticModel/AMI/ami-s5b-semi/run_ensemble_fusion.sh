...
WORD
   ...
   local/score_fusion.sh   --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
                           ...
                           --num-threads 5 --frame-subsampling-factor 3 \
                           data/ihm/semisup/${decode_set}_hires \
                           $src_model_root/tdnn_1b_oracle_sp_bi/graph_poco \
                           $src_model_root/tdnn_1b_sp_bi \
                           $src_model_root/tdnn_1b_sp_bi_semisup_1a_best_phn_nonpost \
                           $exp_root/ensemble/tdnn_fusion_stage/decode_${decode_set}_nopost
   ...
   local/score_fusion.sh   --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
			               ...
			               $src_model_root/tdnn_1b_sp_bi_semisup_1a_best_phn_nonpost \
                           $src_model_root/tdnn_1b_sp_bi_semisup_1a_best_phn \
                           $exp_root/ensemble/tdnn_fusion_stage/decode_${decode_set}_best_phn
    ...
    local/score_fusion.sh  --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
                           ...
                           $src_model_root/tdnn_1b_sp_bi_semisup_1a_best_phn \
			               $src_model_root/tdnn_1b_sp_bi_semisup_1a \
                           $exp_root/ensemble/tdnn_fusion_stage/decode_${decode_set}_semi
