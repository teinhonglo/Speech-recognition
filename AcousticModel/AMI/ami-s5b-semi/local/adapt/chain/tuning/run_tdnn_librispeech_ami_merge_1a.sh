...
if [ $stage -le 1 ]; then
  utils/combine_data_dir.sh $data_dir/$ami_ls_lores_dir $data_dir/$ls_lores_dir $data_dir/$ami_lores_dir
  utils/combine_data_dir.sh $data_dir/$ami_ls_hires_dir $data_dir/$ls_hires_dir $data_dir/$ami_hires_dir
fi
