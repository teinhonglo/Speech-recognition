...
src_ivec_extractor_dir=../../Librispeech/s5/exp/nnet3_cleaned/extractor
...
for f in $data_root/${supervised_set_perturbed}/feats.scp \
  ...
  $src_ivec_extractor_dir/extractor/final.ie $sup_ivector_dir/ivector_online.scp \
...
if [ $stage -le 3 ]; then
  ...
  steps/online/nnet2/extract_ivectors_online.sh --cmd "$train_cmd" --nj $nj \
    $temp_data_root/${unsupervised_set_perturbed}_max2_hires_comb $src_ivec_extractor_dir \
