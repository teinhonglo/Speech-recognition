...
# Unsupervised set: train_unsup10k_86k (20 hour subset of AMI excluding 70 hours for supervised)
...
chain_affix=_semi10k_10k_90k    # affix for chain dir
...
unsup_decode_lang=data/lang_test_poco_ex90k_unk
unsup_decode_graph_affix=_poco_ex90k_unk
