...
exp_root=exp/ihm/semisup_20k/ensemble
# score_comb 
# tdnn_hyp
...
<<WORD
    local/score_combine.sh --cmd "$decode_cmd" --stage 0 \
                           ...
                           $exp_root/tdnn_hyp/decode_${decode_set}
    ...
    local/score_combine.sh --cmd "$decode_cmd" --stage 0 \
                           ...
                           $exp_root/tdnn_hyp/decode_semisup_${decode_set}
    ...
    local/score_combine.sh --cmd "$decode_cmd" --stage 0 \
                           ...
                           $exp_root/tdnn_hyp/decode_semisup_phn_${decode_set}
WORD
    local/score_combine.sh --cmd "$decode_cmd" --stage 0 \
                           data/ihm/semisup/${decode_set}_hires \
                           data/lang_ami.o3g.kn.pr1-7 \
                           ...
                           $exp_root/tdnn_hyp/decode_oracle_${decode_set}	
  done
fi
...
if [ $stage -le 2 ]; then
  ...
  for decode_set in dev eval; do
    local/score_fusion.sh --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
                           ...
                           data/ihm/semisup/${decode_set}_hires \
                           data/lang_ami.o3g.kn.pr1-7 \
                           $src_model_root/tdnn_1a_sp_bi/decode_${decode_set} \
                           $src_model_root/tdnn_1b_sp_bi/decode_${decode_set} \
                           $src_model_root/tdnn_1c_sp_bi/decode_${decode_set} \
                           $src_model_root/tdnn_1d_sp_bi/decode_${decode_set} \
                           $exp_root/tdnn_fusion/decode_${decode_set}
    ...
    local/score_fusion.sh --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
                           ...
                           $src_model_root/tdnn_1c_sp_bi_semisup_1c/decode${decode_affix}_${decode_set}:1 \
                           $src_model_root/tdnn_1d_sp_bi_semisup_1d/decode${decode_affix}_${decode_set}:1 \
                           $exp_root/tdnn_fusion/decode_semisup_${decode_set}
    ...
    local/score_fusion.sh --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
                           ...
                           data/ihm/semisup/${decode_set}_hires \
                           data/lang_ami.o3g.kn.pr1-7 \
                           $src_model_root/tdnn_1a_sp_bi_semisup_1b_best_phn/decode${decode_affix}_best_phn_${decode_set} \
                           $src_model_root/tdnn_1b_sp_bi_semisup_1a_best_phn/decode${decode_affix}_best_phn_${decode_set} \
                           $src_model_root/tdnn_1c_sp_bi_semisup_1c_best_phn/decode${decode_affix}_best_phn_${decode_set} \
                           $src_model_root/tdnn_1d_sp_bi_semisup_1d_best_phn/decode${decode_affix}_best_phn_${decode_set} \
                           $exp_root/tdnn_fusion/decode_semisup_phn_${decode_set}
    ...
    local/score_fusion.sh --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
                           ...
                           data/ihm/semisup/${decode_set}_hires \
                           data/lang_ami.o3g.kn.pr1-7 \
                           $src_model_root/tdnn_1a_oracle_sp_bi/decode_${decode_set} \
                           $src_model_root/tdnn_1b_oracle_sp_bi/decode_${decode_set} \
                           $src_model_root/tdnn_1c_oracle_sp_bi/decode_${decode_set} \
                           $src_model_root/tdnn_1d_oracle_sp_bi/decode_${decode_set} \
                           $exp_root/tdnn_fusion/decode_oracle_${decode_set}
<<WORD
    local/score_fusion.sh --cmd "$decode_cmd" --stage 0 --acwt 1.0 --post-decode-acwt 10.0 \
	                       --online-ivector-dir $ivector_root_dir/ivectors_${decode_set}_hires \
						   --num-threads 5 --frame-subsampling-factor 3 \
